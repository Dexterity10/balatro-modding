...
-- local atlas_path_hc = atlas_key .. '_hc.png'                             -- Filename for the high-contrast version of the texture, if existing

local suits = { 'diamonds', 'spades' }    -- Which suits to replace
